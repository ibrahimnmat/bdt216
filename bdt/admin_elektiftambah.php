	...
	function validate(form)
{
	...
	{
		alert("Sila masukkan maklumat elektif di ruang yang disediakan!!");
...
<fieldset>
<legend><strong>Tambahan Rekod Bagi Elektif</strong></legend>
<form name=form method=post action=admin_elektiftambah2.php onSubmit="return validate(this)">	
