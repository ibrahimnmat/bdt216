...
<title>Tambahan Rekod Bagi Ambilan</title>
	...
	function validate(form)
{
	...
	{
		alert("Sila masukkan maklumat ambilan di ruang yang disediakan!!");
...
<fieldset>
<legend><strong>Tambahan Rekod Bagi Ambilan</strong></legend>
<form name=form method=post action=admin_ambilantambah2.php onSubmit="return validate(this)">	
