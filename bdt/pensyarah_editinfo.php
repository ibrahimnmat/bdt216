...
<fieldset><legend><b>Kemaskini Maklumat Peribadi Pensyarah</b></legend>

<script language=javascript src="include/form.js">
</script>

<form name=form method=post action="pensyarah_editinfo2.php" onSubmit="return validate(this)">
  ...
  <tr>
        ...
        <td width="70%">
          <input type="text" name="app_position" size="65" value="<?php echo $row['position'] ?>">
        </td>
  </tr>
  <tr>
   	    <td width="30%">Jabatan</td>
        <td width="70%">
          <input type="text" name="app_department" size="65" value="<?php echo $row['department'] ?>">
        </td>
  </tr><tr>
...
<tr>
	    <td width="30%">Emel </td>
        <td width="70%">
<input type=text size=40 name="app_email" maxlength=50 onBlur="checkChar(form.app_email.value,'app_email','form'); return true;" value="<?php echo $row['email'] ?>">&nbsp;&nbsp;<em>Contoh: pensyarah@ipgkrajang.edu.my </em></td>
</tr> 
  <tr>      
